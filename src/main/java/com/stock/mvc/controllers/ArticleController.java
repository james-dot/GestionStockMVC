...
public class ArticleController {
	...
	public String ajouterArticle(Model model) {
		 ...
		 List<Categorie> categories = categorieService.selectAll(); //chaque article a une categorie
		 if(categories == null) {
	...
	//on est ajouter la liste des categories
	...
	public String supprimerClient(Model model, @PathVariable Long idArticle) {
		if(idArticle != null) {
			Article article = articleService.getById(idArticle);
			if(article != null) {
				//TODO Verification avant suppression si il a un commande
