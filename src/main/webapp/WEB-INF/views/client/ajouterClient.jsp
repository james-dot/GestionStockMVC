...
<body id="page-top">
	...
	<div class="container">	
		...
		<!-- forrmulaire pour ajouter et modifier client -->
              					   <f:form modelAttribute="client" action="${urlEnregistrer}" enctype="multipart/form-data" role="form"><!-- enctype: envoyer une photo pour enregister  -->
